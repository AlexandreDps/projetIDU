   ...
   <body class="main-layout">
	  ...
	  <div class="table">
        <section class="table__header">
            <h1 style="visibility:hidden">Mes polypoints</h1>
            </div>
        </section>
        <section class="table__body">
            <table>
                <thead>
                    <tr>
                        <th> Intitulé <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Tache <span class="icon-arrow">&UpArrow;</span></th>
                        <th> nbr polypoints <span class="icon-arrow">&UpArrow;</span></th>
